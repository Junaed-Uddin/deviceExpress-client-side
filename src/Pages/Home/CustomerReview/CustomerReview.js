...
const CustomerReview = () => {
    return (
        <section className="my-8 dark:bg-gray-100 dark:text-gray-800">
            <div className="container flex flex-col items-center mx-auto md:pt-20 md:px-12">
                <h1 className="p-4 text-4xl font-semibold leading-none text-center">Customer Review</h1>
            </div>
